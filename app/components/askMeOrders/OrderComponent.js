            ...
            <Pressable style={[styles.container, elevations[10]]}>
                ...
                <View style={styles.infoContainer}>
                    <View style={styles.rowContainer}>
                        <Text style={styles.name}> {item.service.title} </Text>
                        <Text style={[styles.orderStatus, { color }]}> {item.completed ? "مكتمل" : "not completed"} </Text>
                    </View>
                    <View style={styles.rowContainer}>
                        <Text style={styles.orderNumberText}>{item.description}</Text>
